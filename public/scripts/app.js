  ...
  var CheckboxBinding = (function(Backbone){
    ...
    methods.bind = function(selector, view, model, config){
      ...
      view.$(selector).each(function(index){
        ...
        var arrayAttr = config.getBindingValue(element, 'checkbox').substr(-2) == '[]'
        ...
        var modelChange = function(model, val){
          if(arrayAttr) {
            var test = val.indexOf(element.val()) > -1;  
          } else {
            var test = val;
          }
        ...
        var elementChange = function(ev){
          ...
          if (arrayAttr) {
            var values = $.map(
              view.$("input:checkbox["+bindingAttr+"="+attribute_name+"\\[\\]]:checked"), 
              function(elem) { return $(elem).val(); }
            )
...
(function (root, factory) {
  ...
  "views/chunk_edit/_matches_view": function(exports, require, module) {
    (function() {
  var matchesTemplate,
  ...
  exports.MatchesView = (function(_super) {
    ...
    MatchesView.prototype.id = 'ajax';

    MatchesView.prototype.events = {
    ...
    MatchesView.prototype.bind = function() {
      return this.chunk.bind('change:type', this.getMatches);
    };

    MatchesView.prototype.unbind = function() {
      return this.chunk.unbind('change:type', this.getMatches);
    };

    MatchesView.prototype.remove = function() {
      this.unbind();
      return this.$(this.el).remove();
    };

    MatchesView.prototype.render = function() {
      this.$(this.el).html(matchesTemplate({
        chunk: this.chunk,
        state: this.state
      }));
      return this;
    ...
    MatchesView.prototype.getMatches = function() {
      this.chunk.getMatches(this.handleMatchesSuccess, this.handleMatchesFailure);
      this.state = 'waiting';
      return this.render();
    };

    MatchesView.prototype.handleMatchesSuccess = function(results) {
    ...
    MatchesView.prototype.handleMatchesFailure = function(results) {
      this.state = 'error';
      return this.render();
    };
...
(this.require.define({
  "collections/chunk_collection": function(exports, require, module) {
    (function() {
  var Chunk,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = Object.prototype.hasOwnProperty,
  ...
  exports.ChunkCollection = (function(_super) {

    __extends(ChunkCollection, _super);

    function ChunkCollection() {
      this.parse = __bind(this.parse, this);
      this.groupChunks = __bind(this.groupChunks, this);
      this.replaceText = __bind(this.replaceText, this);
      this.searchText = __bind(this.searchText, this);
      this.originalText = __bind(this.originalText, this);
      this.initialize = __bind(this.initialize, this);
      ChunkCollection.__super__.constructor.apply(this, arguments);
    }

    ChunkCollection.prototype.model = Chunk;

    ChunkCollection.prototype.url = '/next';

    ChunkCollection.prototype.initialize = function() {
      this.bind('add', this.groupChunks);
      this.bind('remove', this.groupChunks);
      return this.bind('change:anonymize', this.groupChunks);
    };

    ChunkCollection.prototype.originalText = function() {
      return this.models.map(function(chunk) {
        return chunk.get('content');
      }).join();
    };

    ChunkCollection.prototype.searchText = function() {
      var chunk;
      return "^" + (((function() {
    ...
    ChunkCollection.prototype.replaceText = function() {
      var chunk;
      return ((function() {
        var _i, _len, _ref, _results;
        _ref = this.models;
    ...
    ChunkCollection.prototype.groupChunks = function() {
    ...
    ChunkCollection.prototype.parse = function(response) {
      this.redactor.get('scope').set({
...
(this.require.define({
  "collections/redactor_collection": function(exports, require, module) {
    (function() {
  var Redactor,
    __hasProp = Object.prototype.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };

  Redactor = require('models/redactor').Redactor;

  exports.RedactorCollection = (function(_super) {

    __extends(RedactorCollection, _super);

    function RedactorCollection() {
      RedactorCollection.__super__.constructor.apply(this, arguments);
    }

    RedactorCollection.prototype.model = Redactor;

    RedactorCollection.prototype.url = '/redactors';

    return RedactorCollection;
...
(this.require.define({
  ...
  exports.TestResults = (function(_super) {
    ...
    function TestResults() {
      ...
      this.testRedactor = __bind(this.testRedactor, this);
      this.handleRedactorEvent = __bind(this.handleRedactorEvent, this);
      this.initialize = __bind(this.initialize, this);
    ...
    TestResults.prototype.initialize = function(redactor) {
      this.resultCount = null;
      this.state = 'idle';
      this.redactor = redactor;
      return this.redactor.get('chunks').bind('all', this.handleRedactorEvent);
    };

    TestResults.prototype.handleRedactorEvent = function() {
      if (this.redactor.length < 2) {
        if (this.state !== 'idle') {
          this.resultCount = null;
          this.state = 'idle';
        ...
        return this.testRedactor();
      }
    };

    TestResults.prototype.testRedactor = function() {
      this.post({
        search: this.redactor.get('chunks').searchText(),
        replace: this.redactor.get('chunks').replaceText()
    ...
    TestResults.prototype.testCallback = function(results) {
      if (results['regex'] === ("" + (this.redactor.get('chunks').searchText()))) {
...
(this.require.define({
  ...
  exports.Chunk = (function(_super) {
    ...
    Chunk.prototype.replaceText = function() {
      if (this.get('anonymize') && this.get('collapse') !== true) {
        if (this.get("type") === 'literal' && !this.get("pass_through")) {
          return "";
        } else {
    ...
    Chunk.prototype.getMatches = function(callback, failback) {
      ...
      }, "/get_matches/" + (this.index() + 1), callback, failback);
    };
...
(this.require.define({
  "models/redaction_scope": function(exports, require, module) {
    (function() {
  var Redactor, RedactorCollection,
    __hasProp = Object.prototype.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };

  RedactorCollection = require('collections/redactor_collection').RedactorCollection;

  Redactor = require('models/redactor').Redactor;

  exports.RedactionScope = (function(_super) {

    __extends(RedactionScope, _super);

    function RedactionScope() {
      RedactionScope.__super__.constructor.apply(this, arguments);
    }

    RedactionScope.prototype.relations = [
      {
    ...
    RedactionScope.prototype.defaults = {
      scope: null,
...
(this.require.define({
  "models/redactor": function(exports, require, module) {
    (function() {
  var Chunk, ChunkCollection,
    __hasProp = Object.prototype.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };

  Chunk = require('models/chunk').Chunk;

  ChunkCollection = require('collections/chunk_collection').ChunkCollection;

  exports.Redactor = (function(_super) {

    __extends(Redactor, _super);

    function Redactor() {
      Redactor.__super__.constructor.apply(this, arguments);
    }

    Redactor.prototype.relations = [
      {
        type: Backbone.HasMany,
        key: 'chunks',
        relatedModel: Chunk,
    ...
    Redactor.prototype.save = function() {
      return this.post({
        search: this.get('chunks').searchText(),
        replace: this.get('chunks').replaceText(),
        chunks: this.get('chunks').toJSON()
      }, "filters");
    };

    Redactor.prototype.post = function(data, url, callback, failback) {
      return $.ajax({
        type: "POST",
        url: url,
        data: JSON.stringify(data),
...
(this.require.define({
  ...
  exports.MainRouter = (function(_super) {
    ...
    MainRouter.prototype["new"] = function() {
      ...
      return _gaq.push(['_trackEvent', 'Route', 'Load', 'New']);
    };
    ...
    MainRouter.prototype.edit = function() {
      ...
      if (app.redactor.get('chunks').length === 0) {
        ...
        $('body').html(view.render().el);
        app.current_views = [view];
        return _gaq.push(['_trackEvent', 'Route', 'Load', 'Edit']);
      }
    };

    MainRouter.prototype.chunk_edit = function(id) {
      var baseView, view, _i, _len, _ref;
      if (!app.redactor || !app.redactor.get('chunks').at(id) || !app.redactor.get('chunks').at(id).get("anonymize")) {
        ...
        view = new ChunkEditView({
          chunk: app.redactor.get('chunks').at(id),
          router: this
        });
        $('body').empty();
        $('body').html(view.render().el);
        ...
        return _gaq.push(['_trackEvent', 'Route', 'Load', 'ChunkEdit']);
      }
    };
...
(this.require.define({
  "initialize": function(exports, require, module) {
    (function() {
  var BrunchApplication, MainRouter, RedactionScope, Redactor, TestResults,
    __hasProp = Object.prototype.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };
  ...
  RedactionScope = require('models/redaction_scope').RedactionScope;
  ...
  exports.Application = (function(_super) {
    ...
    Application.prototype.initialize = function() {
      ...
      this.scope = new RedactionScope;
      this.redactor = new Redactor;
      this.scope.get('redactors').add(this.redactor);
      this.test_results = new TestResults(this.redactor);
...
(this.require.define({
  "views/chunk_edit/_options_view": function(exports, require, module) {
    (function() {
  var optionsTemplate,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = Object.prototype.hasOwnProperty,
  ...
  exports.OptionsView = (function(_super) {

    __extends(OptionsView, _super);

    function OptionsView() {
      this.handleGetOptionsFailure = __bind(this.handleGetOptionsFailure, this);
    ...
    OptionsView.prototype.id = 'ajax';

    OptionsView.prototype.initialize = function() {
      this.router = this.options['router'];
      this.model = this.chunk = this.options['chunk'];
      this.state = 'idle';
      if (this.options['bind'] !== false) this.bind();
      return this.handleTypeChange();
    };

    OptionsView.prototype.bind = function() {
      return this.chunk.bind('change:type', this.handleTypeChange);
    };

    OptionsView.prototype.unbind = function() {
      return this.chunk.unbind('change:type', this.handleTypeChange);
    };

    OptionsView.prototype.remove = function() {
      this.unbind();
      return this.$(this.el).remove();
    };

    OptionsView.prototype.render = function() {
      this.$(this.el).html(optionsTemplate({
        chunk: this.chunk,
        state: this.state
      }));
    ...
    OptionsView.prototype.handleTypeChange = function() {
      if (this.chunk.get('options').length < 1) return this.getOptions();
    };

    OptionsView.prototype.getOptions = function() {
      this.chunk.set({
        type: 'glob'
      }, {
        silent: true
      });
      this.chunk.getMatches(this.handleGetOptionsSuccess, this.handleGetOptionsFailure);
      this.chunk.set({
        type: 'set'
      }, {
        silent: true
    ...
    OptionsView.prototype.handleGetOptionsSuccess = function(results) {
    ...
    OptionsView.prototype.handleGetOptionsFailure = function(results) {
      this.state = 'error';
      return this.render();
    };
...
(this.require.define({
  "views/chunk_edit/chunk_edit_view": function(exports, require, module) {
    (function() {
  var MatchesView, OptionsView, chunkEditTemplate,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = Object.prototype.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };

  OptionsView = require('views/chunk_edit/_options_view').OptionsView;

  MatchesView = require('views/chunk_edit/_matches_view').MatchesView;
  ...
  exports.ChunkEditView = (function(_super) {
    ...
    ChunkEditView.prototype.bind = function() {
      this.chunk.bind('change:type', this.render);
      KeyboardJS.bind.key('esc', null, this.cancelAndClose);
      return KeyboardJS.bind.key('enter', null, this.saveAndClose);
    };

    ChunkEditView.prototype.unbind = function() {
      this.chunk.unbind('change:type', this.render);
      KeyboardJS.unbind.key('esc');
      return KeyboardJS.unbind.key('enter');
    };

    ChunkEditView.prototype.remove = function() {
      var view, _i, _len, _ref;
      this.unbind();
    ...
    ChunkEditView.prototype.render = function() {
      ...
      switch (this.chunk.get('type')) {
        case 'set':
          ...
          this.$("#ajax").replaceWith(view.render().el);
          break;
        case 'glob':
        case 'numeric':
        case 'glob-excl':
          view = new MatchesView({
            chunk: this.chunk,
            router: this.router,
            bind: this.options['bind']
          });
...
(this.require.define({
  ...
  exports.ChunkView = (function(_super) {
    ...
    ChunkView.prototype.unbind = function() {
      this.chunk.unbind('all', this.render);
      return this.chunk.unbind('remove', this.remove);
    };
...
(this.require.define({
  "views/edit/_filter_view": function(exports, require, module) {
    (function() {
  var filterTemplate,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = Object.prototype.hasOwnProperty,
  ...
  exports.FilterView = (function(_super) {
    ...
    FilterView.prototype.id = 'filter';

    FilterView.prototype.initialize = function() {
      this.router = this.options['router'];
      this.redactor = this.options['redactor'];
      if (this.options['bind'] !== false) return this.bind();
    };

    FilterView.prototype.bind = function() {
      return this.redactor.bind('all', this.render);
    };

    FilterView.prototype.unbind = function() {
      return this.redactor.bind('all', this.render);
    };
    ...
    FilterView.prototype.render = function() {
      this.$(this.el).html(filterTemplate({
...
(this.require.define({
  ...
  exports.StringView = (function(_super) {
    ...
    StringView.prototype.bind = function() {
      return this.redactor.bind('all', this.render);
    };

    StringView.prototype.unbind = function() {
      return this.redactor.unbind('all', this.render);
    };
    ...
    StringView.prototype.render = function() {
      var _this = this;
      this.remove();
      this.redactor.get('chunks').forEach(function(chunk) {
        var view;
        view = new ChunkView({
          chunk: chunk,
          router: _this.router,
        ...
        _this.$(_this.el).append(view.render().el);
...
(this.require.define({
  ...
  exports.ResultView = (function(_super) {
    ...
    ResultView.prototype.unbind = function() {
      return this.test_result.unbind('all', this.render);
    };
...
(this.require.define({
  ...
  exports.TestView = (function(_super) {
    ...
    TestView.prototype.unbind = function() {
      return this.test_results.unbind('all', this.render);
    };
...
(this.require.define({
  "views/edit/edit_view": function(exports, require, module) {
    (function() {
  var FilterView, StringView, TestView, editTemplate,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = Object.prototype.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype; return child; };
  ...
  FilterView = require('views/edit/_filter_view').FilterView;
  ...
  exports.EditView = (function(_super) {
    ...
    EditView.prototype.initialize = function() {
      ...
      this.child_views = [this.stringView, this.filterView, this.testView];
      if (this.options['bind'] !== false) return this.bind();
    };

    EditView.prototype.bind = function() {
      this.redactor.bind('all', this.render);
    ...
    EditView.prototype.unbind = function() {
      this.redactor.unbind('all', this.render);
      KeyboardJS.unbind.key('esc');
    ...
    EditView.prototype.render = function() {
      ...
      this.$('#filter').replaceWith(this.filterView.render().el);
...
(this.require.define({
  ...
  exports.NewView = (function(_super) {
    ...
    NewView.prototype.initialize = function() {
      this.model = this.redactor = this.options['redactor'];
      this.router = this.options['router'];
      if (this.options['bind'] !== false) return this.bind();
    };

    NewView.prototype.bind = function() {
      return this.redactor.get('chunks').bind('reset', this.navigateToEdit);
    };

    NewView.prototype.unbind = function() {
      return this.redactor.get('chunks').unbind('reset', this.navigateToEdit);
    };
...
(this.require.define({
  "views/chunk_edit/templates/_matches": function(exports, require, module) {
  ...
  return (function() {
    ...
    (function() {
      ...
      if (this.state === 'idle') {
        ...
        _print(_safe('\n  <p class="indent">Example Redactions: <span class="example">'));
        _print(this.chunk.get('matches').join(', '));
        _print(_safe('</span></p>\n'));
...
(this.require.define({
  "views/chunk_edit/templates/_options": function(exports, require, module) {
    module.exports = function(__obj) {
  var _safe = function(value) {
    if (typeof value === 'undefined' && value == null)
      value = '';
  ...
  return (function() {
    ...
    (function() {
      ...
      if (this.state === 'waiting') {
        _print(_safe('\n  <p class="indent">Getting example matches from server <img src="/images/loader_inline.gif"/></p>\n'));
      } else if (this.state === 'received' || this.state === 'idle') {
        _print(_safe('\n  <p class="indent">Match: <span class="example">\n    '));
        _ref = this.chunk.get('matches');
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          match = _ref[_i];
          _print(_safe('\n      <input id="option_'));
          _print(this.chunk.get('matches').indexOf(match));
          _print(_safe('" type="checkbox" name="options[]" value="'));
          _print(match);
          _print(_safe('"/>\n      <label for="option_'));
          _print(this.chunk.get('matches').indexOf(match));
          _print(_safe('">'));
...
(this.require.define({
  "views/edit/templates/_filter": function(exports, require, module) {
    module.exports = function(__obj) {
  var _safe = function(value) {
    if (typeof value === 'undefined' && value == null)
      value = '';
  ...
  return (function() {
    ...
    (function() {
      ...
      _print(_safe('<div id="filter">\n  <div id="search">\n    <span class="label">search for:</span> <span class="console">/'));
    
      _print(this.redactor.get('chunks').searchText());
    
      _print(_safe('/</span>\n  </div>\n  <div id="replace">\n    <span class="label">redact with:</span> <span class="console">\''));
    
      _print(this.redactor.get('chunks').replaceText());
...
(this.require.define({
  ...
  return (function() {
    ...
    (function() {
      ...
      _print(this.test_result.get('raw'));
...
(this.require.define({
  ...
  return (function() {
    ...
    (function() {
      ...
      if (this.chunk.typeIs('glob-excl')) {
      ...
      if (this.chunk.typeIs('numeric')) {
        _print(_safe('\n      <p class="indent">Replace with: <input tabindex=30 name="alias"/></p>\n\n      <div id="ajax"></div>\n   '));
      }
    
      _print(_safe('\n  </p>\n\n  <p>\n    <input tabindex=1040 id="type_literal" type="radio" name="type" value="literal"/> <label for="type_literal"> Match a specific value <span class="example">"'));
    
      _print(this.chunk.get('content'));
    
      _print(_safe('"</span></label>\n\n    '));
    
      if (this.chunk.typeIs('literal')) {
...
(this.require.define({
  "views/edit/templates/edit": function(exports, require, module) {
    module.exports = function(__obj) {
  var _safe = function(value) {
    if (typeof value === 'undefined' && value == null)
      value = '';
  ...
  return (function() {
    ...
    (function() {
      ...
      _print(this.redactor.get('scope').get('percentMatched'));
    
      _print(_safe(' matched using '));
    
      _print(this.redactor.get('scope').get('filterCount'));
